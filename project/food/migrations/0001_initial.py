    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('all_calories', models.PositiveSmallIntegerField(blank=True, default=0, verbose_name='Общая каллорийность блюда')),
            ],
            options={
                'verbose_name': 'Блюдо',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_weight', models.PositiveSmallIntegerField(blank=True, default=0, verbose_name='Вес приготовленного блюда')),
                ('now_weight', models.PositiveSmallIntegerField(blank=True, default=0, verbose_name='Сколько осталось блюда')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_ingredient_items', to='food.ingredient', verbose_name='Основа')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('count_use', models.PositiveSmallIntegerField(default=0, verbose_name='Сколько используется в блюде')),
                ('total_calories', models.PositiveSmallIntegerField(blank=True, default=0, verbose_name='Калории')),
